...
- Add a new class [(#)](https://github.com/OpenEnergyPlatform/open-transport-ontology/pull/)

### Changed

- Update a definition [(#)](https://github.com/OpenEnergyPlatform/open-transport-ontology/pull/)

### Removed

- Remove a broken link [(#)](https://github.com/OpenEnergyPlatform/open-transport-ontology/pull/)
